...
if __name__ == '__main__':
    ...
    data = scipy.io.loadmat('../.data/cheb.nu0.03_ni80.mat')
    nu = data['nu'][0, 0]
    x0 = data['x0']
    t0 = data['t']
    ...
    params_to_save = {'layers_dec': layers_gen, 'layers_enc': layers_enc,
                      ...
                      'dt': dt, 'dn_t': n_t, 't_steps_max': n_dt, 'nu': nu}
    ...
    params = {'col_bs': col_bs, 'n_col': n_col, 'init_bs': init_bs, 'r_bs': r_bs, 'n_i': n_i, 'z_dim': z_dim,
              'alpha': alpha, 'beta': beta, 'gamma': gamma, 'delta': delta,
              'label_noise': label_noise, 'label_true': label_true,
              'dt': dt, 'dn_t': n_t, 't_steps_tot': n_dt, 'bc_bs': bc_bs, 'n_t': n_t, 't_step_loss': t_step_loss,
              'save_path': save_path, 'save_freq': save_freq, 'nu': nu}
